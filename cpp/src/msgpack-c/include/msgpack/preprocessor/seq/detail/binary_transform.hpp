...
#define MSGPACK_PP_SEQ_BINARY_TRANSFORM_A(...)                                                                         \
    (MSGPACK_PP_SEQ_BINARY_TRANSFORM_REM, __VA_ARGS__)() MSGPACK_PP_SEQ_BINARY_TRANSFORM_B
#define MSGPACK_PP_SEQ_BINARY_TRANSFORM_B(...)                                                                         \
    (MSGPACK_PP_SEQ_BINARY_TRANSFORM_REM, __VA_ARGS__)() MSGPACK_PP_SEQ_BINARY_TRANSFORM_A
#else
