...
#define MSGPACK_PP_SEQ_DETAIL_TO_LIST_MSVC(result, seqsize)                                                            \
    MSGPACK_PP_SEQ_DETAIL_TO_LIST_MSVC_STATE_RESULT(MSGPACK_PP_WHILE(                                                  \
        MSGPACK_PP_SEQ_DETAIL_TO_LIST_MSVC_PRED, MSGPACK_PP_SEQ_DETAIL_TO_LIST_MSVC_OP, (result, seqsize)))            \
/**/
