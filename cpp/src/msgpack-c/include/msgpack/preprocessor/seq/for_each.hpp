...
#endif
#
#define MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK_EXEC(macro, data, seq)                                                    \
    MSGPACK_PP_FOR((macro, data, seq, MSGPACK_PP_SEQ_SIZE(seq)),                                                       \
...
#else
#define MSGPACK_PP_SEQ_FOR_EACH_O(r, x)                                                                                \
    MSGPACK_PP_SEQ_FOR_EACH_O_I(MSGPACK_PP_TUPLE_ELEM(4, 0, x),                                                        \
...
#define MSGPACK_PP_SEQ_FOR_EACH_O_I_DEC(macro, data, seq, sz)                                                          \
    (macro, data, MSGPACK_PP_IF(sz, MSGPACK_PP_SEQ_FOR_EACH_O_I_TAIL, MSGPACK_PP_SEQ_FOR_EACH_O_I_NIL)(seq), sz) /**/
...
#else
#define MSGPACK_PP_SEQ_FOR_EACH_M(r, x)                                                                                \
    MSGPACK_PP_SEQ_FOR_EACH_M_I(r,                                                                                     \
...
#endif
#
#define MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK_EXEC_R(r, macro, data, seq)                                               \
    MSGPACK_PP_FOR_##r((macro, data, seq, MSGPACK_PP_SEQ_SIZE(seq)),                                                   \
                       MSGPACK_PP_SEQ_FOR_EACH_P,                                                                      \
                       MSGPACK_PP_SEQ_FOR_EACH_O,                                                                      \
                       MSGPACK_PP_SEQ_FOR_EACH_M)
