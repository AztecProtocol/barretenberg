...
#define MSGPACK_PP_ENUM_SHIFTED_PARAMS(count, param)                                                                   \
    MSGPACK_PP_REPEAT(MSGPACK_PP_DEC(count), MSGPACK_PP_ENUM_SHIFTED_PARAMS_M, param)
#else
#define MSGPACK_PP_ENUM_SHIFTED_PARAMS(count, param) MSGPACK_PP_ENUM_SHIFTED_PARAMS_I(count, param)
#define MSGPACK_PP_ENUM_SHIFTED_PARAMS_I(count, param)                                                                 \
    MSGPACK_PP_REPEAT(MSGPACK_PP_DEC(count), MSGPACK_PP_ENUM_SHIFTED_PARAMS_M, param)
#endif
#
...
#
#if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#define MSGPACK_PP_ENUM_SHIFTED_PARAMS_Z(z, count, param)                                                              \
    MSGPACK_PP_REPEAT_##z(MSGPACK_PP_DEC(count), MSGPACK_PP_ENUM_SHIFTED_PARAMS_M, param)
#else
#define MSGPACK_PP_ENUM_SHIFTED_PARAMS_Z(z, count, param) MSGPACK_PP_ENUM_SHIFTED_PARAMS_Z_I(z, count, param)
#define MSGPACK_PP_ENUM_SHIFTED_PARAMS_Z_I(z, count, param)                                                            \
    MSGPACK_PP_REPEAT_##z(MSGPACK_PP_DEC(count), MSGPACK_PP_ENUM_SHIFTED_PARAMS_M, param)
#endif
#
#endif
