...
#endif
#
#define MSGPACK_PP_REPEAT_FROM_TO                                                                                      \
    MSGPACK_PP_CAT(MSGPACK_PP_REPEAT_FROM_TO_, MSGPACK_PP_AUTO_REC(MSGPACK_PP_REPEAT_P, 4))
#
#define MSGPACK_PP_REPEAT_FROM_TO_1(f, l, m, dt)                                                                       \
    MSGPACK_PP_REPEAT_FROM_TO_D_1(MSGPACK_PP_AUTO_REC(MSGPACK_PP_WHILE_P, 256), f, l, m, dt)
#define MSGPACK_PP_REPEAT_FROM_TO_2(f, l, m, dt)                                                                       \
    MSGPACK_PP_REPEAT_FROM_TO_D_2(MSGPACK_PP_AUTO_REC(MSGPACK_PP_WHILE_P, 256), f, l, m, dt)
#define MSGPACK_PP_REPEAT_FROM_TO_3(f, l, m, dt)                                                                       \
    MSGPACK_PP_REPEAT_FROM_TO_D_3(MSGPACK_PP_AUTO_REC(MSGPACK_PP_WHILE_P, 256), f, l, m, dt)
...
#endif
#
#define MSGPACK_PP_REPEAT_FROM_TO_D                                                                                    \
    MSGPACK_PP_CAT(MSGPACK_PP_REPEAT_FROM_TO_D_, MSGPACK_PP_AUTO_REC(MSGPACK_PP_REPEAT_P, 4))
#
#if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#define MSGPACK_PP_REPEAT_FROM_TO_D_1(d, f, l, m, dt)                                                                  \
    MSGPACK_PP_REPEAT_1(MSGPACK_PP_SUB_D(d, l, f), MSGPACK_PP_REPEAT_FROM_TO_M_1, (d, f, m, dt))
#define MSGPACK_PP_REPEAT_FROM_TO_D_2(d, f, l, m, dt)                                                                  \
    MSGPACK_PP_REPEAT_2(MSGPACK_PP_SUB_D(d, l, f), MSGPACK_PP_REPEAT_FROM_TO_M_2, (d, f, m, dt))
#define MSGPACK_PP_REPEAT_FROM_TO_D_3(d, f, l, m, dt)                                                                  \
    MSGPACK_PP_REPEAT_3(MSGPACK_PP_SUB_D(d, l, f), MSGPACK_PP_REPEAT_FROM_TO_M_3, (d, f, m, dt))
#else
...
#define MSGPACK_PP_REPEAT_FROM_TO_M_1(z, n, dfmd)                                                                      \
    MSGPACK_PP_REPEAT_FROM_TO_M_1_I(z,                                                                                 \
                                    n,                                                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 0, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 1, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 2, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 3, dfmd))
#define MSGPACK_PP_REPEAT_FROM_TO_M_2(z, n, dfmd)                                                                      \
    MSGPACK_PP_REPEAT_FROM_TO_M_2_I(z,                                                                                 \
                                    n,                                                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 0, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 1, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 2, dfmd),                                                 \
...
#define MSGPACK_PP_REPEAT_FROM_TO_M_3(z, n, dfmd)                                                                      \
    MSGPACK_PP_REPEAT_FROM_TO_M_3_I(z,                                                                                 \
                                    n,                                                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 0, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 1, dfmd),                                                 \
                                    MSGPACK_PP_TUPLE_ELEM(4, 2, dfmd),                                                 \
...
#define MSGPACK_PP_REPEAT_FROM_TO_M_1_I(z, n, d, f, m, dt)                                                             \
    MSGPACK_PP_REPEAT_FROM_TO_M_1_II(z, MSGPACK_PP_ADD_D(d, n, f), m, dt)
#define MSGPACK_PP_REPEAT_FROM_TO_M_2_I(z, n, d, f, m, dt)                                                             \
    MSGPACK_PP_REPEAT_FROM_TO_M_2_II(z, MSGPACK_PP_ADD_D(d, n, f), m, dt)
#define MSGPACK_PP_REPEAT_FROM_TO_M_3_I(z, n, d, f, m, dt)                                                             \
    MSGPACK_PP_REPEAT_FROM_TO_M_3_II(z, MSGPACK_PP_ADD_D(d, n, f), m, dt)
#
