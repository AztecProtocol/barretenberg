...
#
#define MSGPACK_PP_FOR_P(n)                                                                                            \
    MSGPACK_PP_CAT(MSGPACK_PP_FOR_CHECK_,                                                                              \
                   MSGPACK_PP_FOR_##n(1, MSGPACK_PP_FOR_SR_P, MSGPACK_PP_FOR_SR_O, MSGPACK_PP_FOR_SR_M))
#
...
#define MSGPACK_PP_FOR_257(s, p, o, m)                                                                                 \
    MSGPACK_PP_IIF(MSGPACK_PP_FOR_257_PR(s, p), MSGPACK_PP_FOR_257_ERROR, MSGPACK_PP_EMPTY)                            \
    () /**/
