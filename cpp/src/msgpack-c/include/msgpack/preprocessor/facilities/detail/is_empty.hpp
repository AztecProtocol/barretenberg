...
#define MSGPACK_PP_DETAIL_IS_EMPTY_PROCESS(param)                                                                      \
    MSGPACK_PP_IS_BEGIN_PARENS(MSGPACK_PP_DETAIL_IS_EMPTY_NON_FUNCTION_C param())                                      \
    /**/

#else

#define MSGPACK_PP_DETAIL_IS_EMPTY_PROCESS(...)                                                                        \
    MSGPACK_PP_IS_BEGIN_PARENS(MSGPACK_PP_DETAIL_IS_EMPTY_NON_FUNCTION_C __VA_ARGS__())                                \
    /**/

#endif

#define MSGPACK_PP_DETAIL_IS_EMPTY_PRIMITIVE_CAT(a, b) a##b
#define MSGPACK_PP_DETAIL_IS_EMPTY_IIF(bit)                                                                            \
    MSGPACK_PP_DETAIL_IS_EMPTY_PRIMITIVE_CAT(MSGPACK_PP_DETAIL_IS_EMPTY_IIF_, bit)
