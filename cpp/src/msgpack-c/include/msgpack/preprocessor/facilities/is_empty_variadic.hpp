...
#define MSGPACK_PP_IS_EMPTY(param)                                                                                     \
    MSGPACK_PP_DETAIL_IS_EMPTY_IIF(MSGPACK_PP_IS_BEGIN_PARENS(param))                                                  \
    (MSGPACK_PP_IS_EMPTY_ZERO, MSGPACK_PP_DETAIL_IS_EMPTY_PROCESS)(param) /**/
#define MSGPACK_PP_IS_EMPTY_ZERO(param) 0
#else
#define MSGPACK_PP_IS_EMPTY(...)                                                                                       \
    MSGPACK_PP_DETAIL_IS_EMPTY_IIF(MSGPACK_PP_IS_BEGIN_PARENS(__VA_ARGS__))                                            \
    (MSGPACK_PP_IS_EMPTY_ZERO, MSGPACK_PP_DETAIL_IS_EMPTY_PROCESS)(__VA_ARGS__) /**/
