...
#define MSGPACK_PP_MUL(x, y)                                                                                           \
    MSGPACK_PP_TUPLE_ELEM(3, 0, MSGPACK_PP_WHILE(MSGPACK_PP_MUL_P, MSGPACK_PP_MUL_O, (0, x, y)))
#else
#define MSGPACK_PP_MUL(x, y) MSGPACK_PP_MUL_I(x, y)
#define MSGPACK_PP_MUL_I(x, y)                                                                                         \
    MSGPACK_PP_TUPLE_ELEM(3, 0, MSGPACK_PP_WHILE(MSGPACK_PP_MUL_P, MSGPACK_PP_MUL_O, (0, x, y)))
#endif
#
...
#else
#define MSGPACK_PP_MUL_O(d, rxy)                                                                                       \
    MSGPACK_PP_MUL_O_I(                                                                                                \
        d, MSGPACK_PP_TUPLE_ELEM(3, 0, rxy), MSGPACK_PP_TUPLE_ELEM(3, 1, rxy), MSGPACK_PP_TUPLE_ELEM(3, 2, rxy))
#endif
#
...
#
#if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#define MSGPACK_PP_MUL_D(d, x, y)                                                                                      \
    MSGPACK_PP_TUPLE_ELEM(3, 0, MSGPACK_PP_WHILE_##d(MSGPACK_PP_MUL_P, MSGPACK_PP_MUL_O, (0, x, y)))
#else
#define MSGPACK_PP_MUL_D(d, x, y) MSGPACK_PP_MUL_D_I(d, x, y)
#define MSGPACK_PP_MUL_D_I(d, x, y)                                                                                    \
    MSGPACK_PP_TUPLE_ELEM(3, 0, MSGPACK_PP_WHILE_##d(MSGPACK_PP_MUL_P, MSGPACK_PP_MUL_O, (0, x, y)))
#endif
#
#endif
