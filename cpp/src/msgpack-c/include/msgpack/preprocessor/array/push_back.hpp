...
#define MSGPACK_PP_ARRAY_PUSH_BACK(array, elem)                                                                        \
    MSGPACK_PP_ARRAY_PUSH_BACK_I(MSGPACK_PP_ARRAY_SIZE(array), MSGPACK_PP_ARRAY_DATA(array), elem)
#else
...
#define MSGPACK_PP_ARRAY_PUSH_BACK_I(size, data, elem)                                                                 \
    (MSGPACK_PP_INC(size), (MSGPACK_PP_ARRAY_DETAIL_GET_DATA(size, data) MSGPACK_PP_COMMA_IF(size) elem))
#
#endif
