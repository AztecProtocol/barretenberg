...
#define MSGPACK_PP_ARRAY_PUSH_FRONT(array, elem)                                                                       \
    MSGPACK_PP_ARRAY_PUSH_FRONT_I(MSGPACK_PP_ARRAY_SIZE(array), MSGPACK_PP_ARRAY_DATA(array), elem)
#else
...
#define MSGPACK_PP_ARRAY_PUSH_FRONT_I(size, data, elem)                                                                \
    (MSGPACK_PP_INC(size), (elem MSGPACK_PP_COMMA_IF(size) MSGPACK_PP_ARRAY_DETAIL_GET_DATA(size, data)))
#
#endif
