...
#define MSGPACK_PP_IS_BEGIN_PARENS(param)                                                                              \
    MSGPACK_PP_DETAIL_IBP_SPLIT(                                                                                       \
        0, MSGPACK_PP_DETAIL_IBP_CAT(MSGPACK_PP_DETAIL_IBP_IS_VARIADIC_R_, MSGPACK_PP_DETAIL_IBP_IS_VARIADIC_C param)) \
    /**/

#else

#define MSGPACK_PP_IS_BEGIN_PARENS(...)                                                                                \
    MSGPACK_PP_DETAIL_IBP_SPLIT(0,                                                                                     \
                                MSGPACK_PP_DETAIL_IBP_CAT(MSGPACK_PP_DETAIL_IBP_IS_VARIADIC_R_,                        \
