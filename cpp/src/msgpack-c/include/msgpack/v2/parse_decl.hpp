...
MSGPACK_API_VERSION_NAMESPACE(v2)
{
     ...
     *
     */
    template <typename Visitor> bool parse(const char* data, size_t len, size_t& off, Visitor& v);
     ...
     *
     */
    template <typename Visitor> bool parse(const char* data, size_t len, Visitor& v);

    namespace detail {

    template <typename Visitor> struct parse_helper;
