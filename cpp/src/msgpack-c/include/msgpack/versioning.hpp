...
#define MSGPACK_DETAIL_PP_CHECK(...)                                                                                   \
    MSGPACK_DETAIL_PP_MSVC_VA_ARGS_WORKAROUND(MSGPACK_DETAIL_PP_CHECK_N, (__VA_ARGS__, 0, 0))
...
#define MSGPACK_DETAIL_PP_NS_ENABLED_PROBE(ns)                                                                         \
    MSGPACK_DETAIL_PP_NS_ENABLED_PROBE_PROXY(MSGPACK_DETAIL_PP_ENABLE_NS_##ns)
...
#define MSGPACK_API_VERSION_NAMESPACE(ns)                                                                              \
    MSGPACK_DETAIL_PP_IIF(MSGPACK_DETAIL_PP_IS_NS_ENABLED(ns))                                                         \
