...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <template <class> class T, class... U> using all_of = detail::all_of_imp<T<U>::value...>;

    template <template <class> class T, class... U> using any_of = detail::any_of_imp<(T<U>::value)...>;
