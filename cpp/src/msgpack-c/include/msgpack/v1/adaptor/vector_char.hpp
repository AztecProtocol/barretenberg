...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <typename Alloc> struct convert<std::vector<char, Alloc>> {
...
#pragma GCC diagnostic pop
    ...
    template <typename Alloc> struct pack<std::vector<char, Alloc>> {
    ...
    template <typename Alloc> struct object<std::vector<char, Alloc>> {
    ...
    template <typename Alloc> struct object_with_zone<std::vector<char, Alloc>> {
