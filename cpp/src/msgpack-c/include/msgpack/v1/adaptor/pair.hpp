...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <typename T1, typename T2> struct convert<std::pair<T1, T2>> {
    ...
    template <typename T1, typename T2> struct pack<std::pair<T1, T2>> {
    ...
    template <typename T1, typename T2> struct object_with_zone<std::pair<T1, T2>> {
