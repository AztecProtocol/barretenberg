...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    struct v4raw_ref {
        ...
        bool operator!=(const v4raw_ref& x) const { return !(*this == x); }
    ...
    template <> struct convert<type::v4raw_ref> {
    ...
    template <> struct pack<type::v4raw_ref> {
    ...
    template <> struct object<type::v4raw_ref> {
    ...
    template <> struct object_with_zone<type::v4raw_ref> {
