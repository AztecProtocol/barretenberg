...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <typename T, typename Alloc> struct convert<std::forward_list<T, Alloc>> {
    ...
    template <typename T, typename Alloc> struct pack<std::forward_list<T, Alloc>> {
    ...
    template <typename T, typename Alloc> struct object_with_zone<std::forward_list<T, Alloc>> {
