...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <std::size_t N> struct convert<std::array<std::byte, N>> {
...
#pragma GCC diagnostic pop
    ...
    template <std::size_t N> struct pack<std::array<std::byte, N>> {
    ...
    template <std::size_t N> struct object<std::array<std::byte, N>> {
    ...
    template <std::size_t N> struct object_with_zone<std::array<std::byte, N>> {
