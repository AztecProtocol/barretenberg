...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <> struct convert<boost::string_view> {
    ...
    template <> struct pack<boost::string_view> {
    ...
    template <> struct object<boost::string_view> {
    ...
    template <> struct object_with_zone<boost::string_view> {
