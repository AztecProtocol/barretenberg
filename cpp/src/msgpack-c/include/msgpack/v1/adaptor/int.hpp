...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <typename T> struct convert_integer_sign<T, true> {
    ...
    template <typename T> inline T convert_integer(msgpack::object const& o)
    {
        return detail::convert_integer_sign<T, is_signed<T>::value>::convert(o);
    }

    template <> struct object_sign<true> {
        template <typename T> static void make(msgpack::object& o, T v)
        {
            if (v < 0) {
    ...
    template <> struct object_sign<false> {
        template <typename T> static void make(msgpack::object& o, T v)
        {
            o.type = msgpack::type::POSITIVE_INTEGER;
            o.via.u64 = v;
    ...
    template <typename T> inline void object_char(msgpack::object& o, T v)
    {
    ...
    template <> struct convert<wchar_t> {
        msgpack::object const& operator()(msgpack::object const& o, wchar_t& v) const
        {
            v = type::detail::convert_integer<wchar_t>(o);
            return o;
        }
    };
    ...
    template <> struct convert<signed short> {
    ...
    template <> struct convert<signed int> {
    ...
    template <> struct convert<signed long> {
    ...
    template <> struct convert<signed long long> {
    ...
    template <> struct pack<char> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, char v) const
        {
            o.pack_char(v);
            return o;
        }
    ...
    template <> struct pack<wchar_t> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, wchar_t v) const
        {
            o.pack_wchar(v);
            return o;
        }
    ...
    template <> struct pack<signed char> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, signed char v) const
        {
    ...
    template <> struct pack<signed short> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, signed short v) const
        {
            o.pack_short(v);
            return o;
        }
    ...
    template <> struct pack<signed int> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, signed int v) const
        {
            o.pack_int(v);
            return o;
        }
    ...
    template <> struct pack<signed long> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, signed long v) const
        {
            o.pack_long(v);
            return o;
        }
    ...
    template <> struct pack<signed long long> {
    ...
    template <> struct pack<unsigned char> {
        template <typename Stream>
    ...
    template <> struct pack<unsigned short> {
        template <typename Stream>
    ...
    template <> struct pack<unsigned int> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, unsigned int v) const
        {
    ...
    template <> struct pack<unsigned long> {
        template <typename Stream>
    ...
    template <> struct pack<unsigned long long> {
        template <typename Stream>
    ...
    template <> struct object<char> {
        void operator()(msgpack::object& o, char v) const { type::detail::object_char(o, v); }
    };

    template <> struct object<wchar_t> {
        void operator()(msgpack::object& o, wchar_t v) const { type::detail::object_char(o, v); }
    };

    template <> struct object<signed char> {
    ...
    template <> struct object<signed short> {
    ...
    template <> struct object<signed int> {
    ...
    template <> struct object<signed long> {
    ...
    template <> struct object<signed long long> {
    ...
    template <> struct object<unsigned char> {
    ...
    template <> struct object<unsigned short> {
    ...
    template <> struct object<unsigned long> {
    ...
    template <> struct object<unsigned long long> {
    ...
    template <> struct object_with_zone<char> {
        void operator()(msgpack::object::with_zone& o, char v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<wchar_t> {
        void operator()(msgpack::object::with_zone& o, wchar_t v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<signed char> {
        void operator()(msgpack::object::with_zone& o, signed char v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<signed short> {
        void operator()(msgpack::object::with_zone& o, signed short v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<signed int> {
        void operator()(msgpack::object::with_zone& o, signed int v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<signed long> {
        void operator()(msgpack::object::with_zone& o, signed long v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<signed long long> {
    ...
    template <> struct object_with_zone<unsigned char> {
        void operator()(msgpack::object::with_zone& o, unsigned char v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<unsigned short> {
    ...
    template <> struct object_with_zone<unsigned int> {
        void operator()(msgpack::object::with_zone& o, unsigned int v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<unsigned long> {
        void operator()(msgpack::object::with_zone& o, unsigned long v) const { static_cast<msgpack::object&>(o) << v; }
    };

    template <> struct object_with_zone<unsigned long long> {
