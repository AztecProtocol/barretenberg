...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <> struct pack<bool> {
        template <typename Stream> msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o, const bool& v) const
        {
            if (v) {
                o.pack_true();
            } else {
    ...
    template <> struct object_with_zone<bool> {
        void operator()(msgpack::object::with_zone& o, bool v) const { static_cast<msgpack::object&>(o) << v; }
    };
