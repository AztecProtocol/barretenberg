...
template <typename Byte> bool operator==(const std::span<const Byte>& lhs, const std::span<const Byte>& rhs)
{
...
template <typename Byte> bool operator==(const std::span<const Byte>& lhs, const std::vector<Byte>& rhs)
{
    return lhs == std::span<const Byte>{ rhs.data(), rhs.size() };
}

template <typename Byte> bool operator==(const std::vector<Byte>& lhs, const std::span<const Byte>& rhs)
{
...
#define MSGPACK_TEST_SPAN_BYTE_PACK_CONVERT(byte_t, display_name)                                                      \
    ...
    {                                                                                                                  \
        std::stringstream ss;                                                                                          \
        byte_t raw_data[] = { (byte_t)(0x01), (byte_t)(0x02), (byte_t)(0x7f), (byte_t)(0x80), (byte_t)(0xff) };        \
