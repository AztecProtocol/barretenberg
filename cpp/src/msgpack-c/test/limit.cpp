...
BOOST_AUTO_TEST_CASE(unpack_array_no_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(3, 0, 0, 0, 0));
        BOOST_CHECK(true);
...
BOOST_AUTO_TEST_CASE(unpack_array_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(2, 0, 0, 0, 0));
        BOOST_CHECK(false);
    } catch (msgpack::array_size_overflow const&) {
        BOOST_CHECK(true);
    } catch (...) {
...
BOOST_AUTO_TEST_CASE(unpack_map_no_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 3, 0, 0, 0));
        BOOST_CHECK(true);
...
BOOST_AUTO_TEST_CASE(unpack_map_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 2, 0, 0, 0));
        BOOST_CHECK(false);
    } catch (msgpack::map_size_overflow const&) {
        BOOST_CHECK(true);
    } catch (...) {
...
BOOST_AUTO_TEST_CASE(unpack_str_no_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 0, 3, 0, 0));
        BOOST_CHECK(true);
...
BOOST_AUTO_TEST_CASE(unpack_str_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 0, 2, 0, 0));
        BOOST_CHECK(false);
    } catch (msgpack::str_size_overflow const&) {
        BOOST_CHECK(true);
    } catch (...) {
...
BOOST_AUTO_TEST_CASE(unpack_bin_no_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 0, 0, 3, 0));
        BOOST_CHECK(true);
...
BOOST_AUTO_TEST_CASE(unpack_bin_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 0, 0, 2, 0));
        BOOST_CHECK(false);
    } catch (msgpack::bin_size_overflow const&) {
        BOOST_CHECK(true);
    } catch (...) {
...
BOOST_AUTO_TEST_CASE(unpack_ext_no_over)
{
    ...
    try {
        msgpack::object_handle oh = msgpack::unpack(ss.str().c_str(),
                                                    ss.str().size(),
                                                    MSGPACK_NULLPTR,
                                                    MSGPACK_NULLPTR,
...
BOOST_AUTO_TEST_CASE(unpack_ext_over_32_bit)
{
    if (sizeof(std::size_t) == 4) {
        char const buf[] = {
            static_cast<char>(0xc9u), static_cast<char>(0xffu), static_cast<char>(0xffu),
            static_cast<char>(0xffu), static_cast<char>(0xffu), static_cast<char>(0x01u),
        };
        try {
            msgpack::object_handle unp;
            msgpack::unpack(
                unp, buf, sizeof(buf), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(0, 0, 0, 0, 0xffffffff));
            BOOST_CHECK(false);
        } catch (msgpack::ext_size_overflow const&) {
            BOOST_CHECK(true);
        } catch (...) {
...
BOOST_AUTO_TEST_CASE(unpack_array_over_cpp11_no_off_no_ref)
{
    ...
    msgpack::pack(ss, v);
    try {
        msgpack::object_handle unp = msgpack::unpack(
            ss.str().c_str(), ss.str().size(), MSGPACK_NULLPTR, MSGPACK_NULLPTR, msgpack::unpack_limit(2, 0, 0, 0, 0));
        BOOST_CHECK(false);
    } catch (msgpack::array_size_overflow const&) {
        BOOST_CHECK(true);
...
BOOST_AUTO_TEST_CASE(unpack_array_over_cpp11_no_off_ref)
{
    ...
    try {
        bool ref;
        msgpack::object_handle unp = msgpack::unpack(ss.str().c_str(),
                                                     ss.str().size(),
                                                     ref,
                                                     MSGPACK_NULLPTR,
                                                     MSGPACK_NULLPTR,
...
BOOST_AUTO_TEST_CASE(unpacker_array_over)
{
    ...
    try {
        msgpack::unpacker u(
            MSGPACK_NULLPTR, MSGPACK_NULLPTR, MSGPACK_UNPACKER_INIT_BUFFER_SIZE, msgpack::unpack_limit(2, 0, 0, 0, 0));
...
{
    msgpack::unpacker u(MSGPACK_NULLPTR, MSGPACK_NULLPTR, MSGPACK_UNPACKER_INIT_BUFFER_SIZE, msgpack::unpack_limit());
