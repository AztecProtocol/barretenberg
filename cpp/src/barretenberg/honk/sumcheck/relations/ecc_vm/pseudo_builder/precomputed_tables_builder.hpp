...
class ECCVMPrecomputedTblesBuilder {
  public:
    ...
    struct PrecomputeState {
        ...
        grumpkin::g1::affine_element precompute_accumulator{ 0, 0 };
        grumpkin::g1::affine_element precompute_double{ 0, 0 };
    };

    static std::vector<PrecomputeState> compute_precompute_state(const std::vector<eccvm::ScalarMul>& ecc_muls)
    {
        ...
        for (const auto& entry : ecc_muls) {
            ...
            const grumpkin::g1::element point = entry.base_point;
