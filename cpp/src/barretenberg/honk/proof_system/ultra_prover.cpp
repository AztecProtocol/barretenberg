...
//  *
//  * */
// template <typename settings> void UltraHonkProver<settings>::compute_wire_commitments()
// {
...
//  *
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_preamble_round()
// {
...
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_wire_commitments_round()
// {
//     // queue.flush_queue(); // NOTE: Don't remove; we may reinstate the queue
...
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_tables_round()
// {
...
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_grand_product_computation_round()
// {
//     // queue.flush_queue(); // NOTE: Don't remove; we may reinstate the queue
...
//     z_permutation =
//         prover_library::compute_permutation_grand_product<settings::program_width>(key, wire_polynomials, beta,
//         gamma);
...
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_relation_check_rounds()
// {
//     // queue.flush_queue(); // NOTE: Don't remove; we may reinstate the queue
...
//  *
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_univariatization_round()
// {
...
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_pcs_evaluation_round()
// {
...
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_shplonk_round()
// {
//     shplonk_output =
...
//  *
//  * */
// template <typename settings> void UltraHonkProver<settings>::execute_kzg_round()
// {
