...
template <typename CircuitConstructor> class UltraPlonkComposerHelper {
  public:
    ...
    {}
    UltraPlonkComposerHelper(std::shared_ptr<bonk::ReferenceStringFactory> crs_factory)
        : crs_factory_(std::move(crs_factory))
    {}

    UltraPlonkComposerHelper(std::unique_ptr<bonk::ReferenceStringFactory>&& crs_factory)
        : crs_factory_(std::move(crs_factory))
    {}
    UltraPlonkComposerHelper(std::shared_ptr<bonk::proving_key> p_key, std::shared_ptr<bonk::verification_key> v_key)
    ...
    UltraPlonkComposerHelper(const UltraPlonkComposerHelper& other) = delete;
    UltraPlonkComposerHelper& operator=(UltraPlonkComposerHelper&& other) noexcept = default;
    UltraPlonkComposerHelper& operator=(const UltraPlonkComposerHelper& other) = delete;
