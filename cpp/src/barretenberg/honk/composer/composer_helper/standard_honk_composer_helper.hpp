...
template <StandardFlavor Flavor> class StandardHonkComposerHelper_ {
  public:
    ...
    StandardHonkComposerHelper_()
        : StandardHonkComposerHelper_(std::shared_ptr<barretenberg::srs::factories::CrsFactory>(
              new barretenberg::srs::factories::FileCrsFactory("../srs_db/ignition")))
    {}
    StandardHonkComposerHelper_(std::shared_ptr<barretenberg::srs::factories::CrsFactory> crs_factory)
        : crs_factory_(std::move(crs_factory))
    {}

    StandardHonkComposerHelper_(std::unique_ptr<barretenberg::srs::factories::CrsFactory>&& crs_factory)
        : crs_factory_(std::move(crs_factory))
    {}
