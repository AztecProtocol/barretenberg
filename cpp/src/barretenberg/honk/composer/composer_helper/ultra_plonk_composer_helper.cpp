...
std::shared_ptr<bonk::proving_key> UltraPlonkComposerHelper<CircuitConstructor>::compute_proving_key_base(
...
template <typename CircuitConstructor>
std::shared_ptr<bonk::verification_key> UltraPlonkComposerHelper<CircuitConstructor>::compute_verification_key_base(
 ...
 * */
template <typename CircuitConstructor>
void UltraPlonkComposerHelper<CircuitConstructor>::compute_witness(const CircuitConstructor& circuit_constructor,
...
template <typename CircuitConstructor>
std::shared_ptr<bonk::proving_key> UltraPlonkComposerHelper<CircuitConstructor>::compute_proving_key(
    const CircuitConstructor& circuit_constructor)
{
    ...
    UltraPlonkComposerHelper::compute_proving_key_base(circuit_constructor, plonk::ComposerType::STANDARD_HONK);
    ...
    const CircuitConstructor& circuit_constructor)
{
    ...
    circuit_verification_key =
        UltraPlonkComposerHelper::compute_verification_key_base(circuit_proving_key, crs_factory_->get_verifier_crs());
...
template <typename CircuitConstructor>
plonk::Verifier UltraPlonkComposerHelper<CircuitConstructor>::create_verifier(
    const CircuitConstructor& circuit_constructor)
{
 ...
 * */
template <typename CircuitConstructor>
plonk::Prover UltraPlonkComposerHelper<CircuitConstructor>::create_prover(const CircuitConstructor& circuit_constructor)
{
...
template class UltraPlonkComposerHelper<StandardCircuitConstructor>;
} // namespace bonk
