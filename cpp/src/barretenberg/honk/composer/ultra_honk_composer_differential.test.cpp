...
// namespace test_ultra_honk_composer_differential {
...
// // /**
// //  * @brief TEMPORARY (verbose) method for checking consistency of polynomials computed by Ultra Plonk/Honk
// composers
// //  *
// //  * @param honk_prover
// //  * @param plonk_prover
...
// TEST(UltraHonkComposerDifferential, create_gates_from_plookup_accumulators)
// {
...
//  *
//  */
// TEST(UltraHonkComposerDifferential, test_no_lookup_proof)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, test_elliptic_gate)
// {
...
// TEST(UltraHonkComposerDifferential, non_trivial_tag_permutation)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, non_trivial_tag_permutation_and_cycles)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, bad_tag_permutation)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, sort_widget)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, sort_with_edges_gate)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, range_constraint)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, range_with_gates)
// {
...
// TEST(UltraHonkComposerDifferential, range_with_gates_where_range_is_not_a_power_of_two)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, sort_widget_complex)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, composed_range_constraint)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, non_native_field_multiplication)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
// TEST(UltraHonkComposerDifferential, rom)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
...
//         const auto d_value =
//             honk_composer.get_variable(a_idx) + honk_composer.get_variable(b_idx) +
//             honk_composer.get_variable(c_idx);
...
// TEST(UltraHonkComposerDifferential, ram)
// {
//     auto honk_composer = UltraHonkComposer();
//     auto plonk_composer = proof_system::plonk::UltraComposer();
