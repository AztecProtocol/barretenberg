 ...
 *
 */
TEST(UltraHonkComposer, SumcheckEvaluations)
{
    ...
    // Check that sumcheck has produced correct multilinear evaluations
    auto challenge = prover.sumcheck_output.challenge_point;
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_l, prover.key->w_l.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_r, prover.key->w_r.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_o, prover.key->w_o.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_4, prover.key->w_4.evaluate_mle(challenge));

    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_l_shift, prover.key->w_l.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_r_shift, prover.key->w_r.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_o_shift, prover.key->w_o.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.w_4_shift, prover.key->w_4.evaluate_mle(challenge, true));

    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_c, prover.key->q_c.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_l, prover.key->q_l.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_r, prover.key->q_r.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_o, prover.key->q_o.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_4, prover.key->q_4.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_m, prover.key->q_m.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_arith, prover.key->q_arith.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_sort, prover.key->q_sort.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_elliptic, prover.key->q_elliptic.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_aux, prover.key->q_aux.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.q_lookup, prover.key->q_lookup.evaluate_mle(challenge));

    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.sigma_1, prover.key->sigma_1.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.sigma_2, prover.key->sigma_2.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.sigma_3, prover.key->sigma_3.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.sigma_4, prover.key->sigma_4.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.id_1, prover.key->id_1.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.id_2, prover.key->id_2.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.id_3, prover.key->id_3.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.id_4, prover.key->id_4.evaluate_mle(challenge));

    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_1, prover.key->table_1.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_2, prover.key->table_2.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_3, prover.key->table_3.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_4, prover.key->table_4.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_1_shift,
              prover.key->table_1.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_2_shift,
              prover.key->table_2.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_3_shift,
              prover.key->table_3.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.table_4_shift,
              prover.key->table_4.evaluate_mle(challenge, true));

    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.sorted_accum,
              prover.key->sorted_accum.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.z_perm, prover.key->z_perm.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.z_lookup, prover.key->z_lookup.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.sorted_accum_shift,
              prover.key->sorted_accum.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.z_perm_shift,
              prover.key->z_perm.evaluate_mle(challenge, true));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.z_lookup_shift,
              prover.key->z_lookup.evaluate_mle(challenge, true));

    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.lagrange_first,
              prover.key->lagrange_first.evaluate_mle(challenge));
    ASSERT_EQ(prover.sumcheck_output.purported_evaluations.lagrange_last,
