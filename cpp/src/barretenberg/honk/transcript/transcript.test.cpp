...
template <typename Flavor> class TranscriptTest : public testing::Test {
  public:
...
TYPED_TEST_SUITE(TranscriptTest, StandardFlavorTypes);
...
TYPED_TEST(TranscriptTest, ProverManifestConsistency)
{
    ...
    auto composer = StandardHonkComposer_<Flavor>();
    fr a = 1;
 ...
 *
 */
// TODO: This is not a typed test and we should have a construct_ultra_honk_manifest as well.
TYPED_TEST(TranscriptTest, UltraVerifierManifestConsistency)
{
    // Construct a simple circuit of size n = 8 (i.e. the minimum circuit size)
