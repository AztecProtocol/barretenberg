...
template <typename Fr, typename Fq, typename G1> class InnerProductArgument {
  public:
                              ...
                              const std::vector<affine_element>& G_vector)
    {
        ...
        // TODO(Arijit): To accomodate non power of two poly_degree
        ...
        // TODO(Arijit):  to make it more efficient by directly using G_vector for the input points when i = 0 and write
        // the output points to G_vec_local. Then use G_vec_local for rounds where i>0, this can be done after we use
        // SRS instead of G_vector.
        std::vector<affine_element> G_vec_local(poly_degree);
        for (size_t i = 0; i < poly_degree; i++) {
            G_vec_local[i] = G_vector[i];
        }
        // Construct b vector
        // TODO(Arijit): For round i=0, b_vec can be derived in-place.
        ...
        for (size_t i = 0; i < log_poly_degree; i++) {
            ...
            // TODO(Arijit): Remove usage of multiple runtime_state, pass it as an element of the SRS.
            ...
            // Generate the round challenge. TODO(Arijit): Use Fiat-Shamir
            ...
            for (size_t j = 0; j < round_size; j++) {
                ...
                /*
                TODO(Arijit): (performance improvement suggested by Zac): We can improve performance here by using
