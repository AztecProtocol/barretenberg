...
template <typename Curve> class Standard : public Arithmetization</*NUM_WIRES =*/3, /*num_selectors =*/5> {
  public:
...
template <typename Curve> class Turbo : public Arithmetization</*NUM_WIRES =*/4, /*num_selectors =*/11> {
  public:
    using FF = typename Curve::ScalarField;
    struct Selectors : SelectorsBase<FF, num_selectors> {
        std::vector<FF, barretenberg::ContainerSlabAllocator<FF>>& q_m = std::get<0>(this->_data);
...
template <typename Curve> class Ultra : public Arithmetization</*NUM_WIRES =*/4, /*num_selectors =*/11> {
  public:
    using FF = typename Curve::ScalarField;
    struct Selectors : SelectorsBase<FF, num_selectors> {
        std::vector<FF, barretenberg::ContainerSlabAllocator<FF>>& q_m = std::get<0>(this->_data);
