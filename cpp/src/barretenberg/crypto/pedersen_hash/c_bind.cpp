...
void WASM_EXPORT(pedersen_hash_pair)(uint8_t const* left, uint8_t const* right, uint8_t* result)
{
...
void WASM_EXPORT(pedersen_hash_multiple)(uint8_t const* inputs_buffer, uint8_t* output)
{
...
void WASM_EXPORT(pedersen_hash_multiple_with_hash_index)(uint8_t const* inputs_buffer,
