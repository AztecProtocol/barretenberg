...
WASM_EXPORT void schnorr__compute_public_key(fr::in_buf private_key, affine_element::out_buf public_key_buf);
WASM_EXPORT void schnorr__negate_public_key(affine_element::in_buf public_key_buffer, affine_element::out_buf output);

WASM_EXPORT void schnorr__construct_signature(uint8_t const* message, fr::in_buf private_key, out_buf32 s, out_buf32 e);
...
WASM_EXPORT void schnorr__multisig_create_multisig_public_key(fq::in_buf private_key,
                                                              multisig::MultiSigPublicKey::out_buf multisig_pubkey_buf);

WASM_EXPORT void schnorr__multisig_validate_and_combine_signer_pubkeys(
    multisig::MultiSigPublicKey::vec_in_buf signer_pubkey_buf, affine_element::out_buf combined_key_buf, bool* success);

WASM_EXPORT void schnorr__multisig_construct_signature_round_1(
...
WASM_EXPORT void schnorr__multisig_construct_signature_round_2(
...
WASM_EXPORT void schnorr__multisig_combine_signatures(uint8_t const* message,
                                                      multisig::MultiSigPublicKey::vec_in_buf signer_pubkeys_buf,
