...
#include "barretenberg/plonk/composer/plookup_tables/aes128.hpp"
...
UltraPlonkComposer::UltraPlonkComposer()
    : UltraPlonkComposer("../srs_db/ignition", 0)
{}

UltraPlonkComposer::UltraPlonkComposer(std::string const& crs_path, const size_t size_hint)
...
//  */
// void UltraPlonkComposer::create_add_gate(const add_triple& in)
// {
//     ULTRA_SELECTOR_REFS
...
//  */
// void UltraPlonkComposer::create_big_add_gate(const add_quad& in, const bool include_next_gate_w_4)
// {
//     ULTRA_SELECTOR_REFS
...
//  */
// void UltraPlonkComposer::create_big_add_gate_with_bit_extraction(const add_quad& in)
// {
...
// }
// /**
//  * @brief Create a basic multiplication gate q_m * a * b + q_1 * a + q_2 * b + q_3 * c + q_4 * d + q_c = 0 (q_arith =
//  1)
//  *
//  * @param in Structure containing variables and witness selectors
//  */
// void UltraPlonkComposer::create_big_mul_gate(const mul_quad& in)
// {
//     ULTRA_SELECTOR_REFS
//     assert_valid_variables({ in.a, in.b, in.c, in.d });
...
// void UltraPlonkComposer::create_balanced_add_gate(const add_quad& in)
// {
//     ULTRA_SELECTOR_REFS
//     assert_valid_variables({ in.a, in.b, in.c, in.d });
...
//  * @param in Structure containing variables and witness selectors
//  */
// void UltraPlonkComposer::create_mul_gate(const mul_triple& in)
// {
//     ULTRA_SELECTOR_REFS
//     assert_valid_variables({ in.a, in.b, in.c });
...
//  */
// void UltraPlonkComposer::create_bool_gate(const uint32_t variable_index)
// {
//     ULTRA_SELECTOR_REFS
...
// /**
//  * @brief A plonk gate with disabled (set to zero) fourth wire. q_m * a * b + q_1 * a + q_2 * b + q_3 * c + q_const =
//  0
//  *
//  * @param in Structure containing variables and witness selectors
//  */
// void UltraPlonkComposer::create_poly_gate(const poly_triple& in)
// {
//     ULTRA_SELECTOR_REFS
//     assert_valid_variables({ in.a, in.b, in.c });
...
//  *
//  * @param in Elliptic curve point addition gate parameters, including the the affine coordinates of the two points
//  being
//  * added, the resulting point coordinates and the selector values that describe whether the endomorphism is used on
//  the
//  * second point and whether it is negated.
//  */
// void UltraPlonkComposer::create_ecc_add_gate(const ecc_add_gate& in)
// {
//     /**
//      * | 1  | 2  | 3  | 4  |
//      * | a1 | a2 | x1 | y1 |
...
//  */
// void UltraPlonkComposer::fix_witness(const uint32_t witness_index, const barretenberg::fr& witness_value)
// {
//     ULTRA_SELECTOR_REFS
...
// uint32_t UltraPlonkComposer::put_constant_variable(const barretenberg::fr& variable)
// {
...
// void UltraPlonkComposer::add_table_column_selector_poly_to_proving_key(polynomial& selector_poly_lagrange_form,
...
//     info("real proving key tables_size = ", tables_size);
//     info("real proving key lookups_size = ", lookups_size);
//     info("real proving key num_gates = ", num_gates);
...
// // std::shared_ptr<verification_key> UltraPlonkComposer::compute_verification_key()
// // {
...
//  * elsewhere.
//  */
// void UltraPlonkComposer::compute_witness()
// {
//     if (computed_witness) {
//         return;
//     }
...
//  */
// UltraToStandardProver UltraPlonkComposer::create_ultra_to_standard_prover()
// {
//     compute_proving_key();
//     compute_witness();
...
// UltraVerifier UltraPlonkComposer::create_verifier()
// {
//     compute_verification_key();

//     info("circuit_proving_key->circuit_size = ", circuit_proving_key->circuit_size);
//     info("composer_helper.circuit_proving_key->circuit_size = ", composer_helper.circuit_proving_key->circuit_size);
//     ASSERT(circuit_proving_key == composer_helper.circuit_proving_key);
...
// UltraToStandardVerifier UltraPlonkComposer::create_ultra_to_standard_verifier()
// {
//     compute_verification_key();
...
// void UltraPlonkComposer::initialize_precomputed_table(
...
// plookup::BasicTable& UltraPlonkComposer::get_table(const plookup::BasicTableId id)
// {
...
//  */
// plookup::ReadData<uint32_t> UltraPlonkComposer::create_gates_from_plookup_accumulators(
...
// UltraPlonkComposer::RangeList UltraPlonkComposer::create_range_list(const uint64_t target_range)
// {
//     RangeList result;
...
// std::vector<uint32_t> UltraPlonkComposer::decompose_into_default_range(const uint32_t variable_index,
...
//      * However, this produces an edge-case where a variable is range-constrained but NOT present in an arithmetic
//      gate.
...
//  * @param target_range
//  */
// void UltraPlonkComposer::create_new_range_constraint(const uint32_t variable_index,
...
// void UltraPlonkComposer::process_range_list(const RangeList& list)
// {
...
// void UltraPlonkComposer::process_range_lists()
// {
...
// void UltraPlonkComposer::create_sort_constraint(const std::vector<uint32_t>& variable_index)
// {
//     ULTRA_SELECTOR_REFS
//     constexpr size_t gate_width = ultra_settings::program_width;
...
// // useful to put variables in the witness that aren't already used - e.g. the dummy variables of the range constraint
// in
// // multiples of three
// void UltraPlonkComposer::create_dummy_constraints(const std::vector<uint32_t>& variable_index)
// {
//     ULTRA_SELECTOR_REFS
...
// void UltraPlonkComposer::create_sort_constraint_with_edges(const std::vector<uint32_t>& variable_index,
//                                                            const fr& start,
//                                                            const fr& end)
// {
//     ULTRA_SELECTOR_REFS
...
// // range constraint a value by decomposing it into limbs whose size should be the default range constraint size
// std::vector<uint32_t> UltraPlonkComposer::decompose_into_default_range_better_for_oddlimbnum(
...
//     if (limb_num < 3) {
//         std::cerr
//             << "number of bits in range must be an integer multipe of DEFAULT_PLOOKUP_RANGE_BITNUM of size at least
//             3"
//             << std::endl;
//         return sums;
//     }
...
//  * (if we put each of them into a separate widget they would not require any selectors other than the ones enabling
//  the
...
//  * @param type
//  */
// void UltraPlonkComposer::apply_aux_selectors(const AUX_SELECTORS type)
// {
//     ULTRA_SELECTOR_REFS;
...
//         // 'read', validate adjacent values do not change Used for ROM reads and RAM reads across read/write
//         boundaries q_1.emplace_back(0); q_2.emplace_back(0); q_3.emplace_back(0); q_4.emplace_back(0);
//         q_m.emplace_back(0);
//         q_c.emplace_back(0);
//         q_arith.emplace_back(1);
//         break;
...
//  **/
// void UltraPlonkComposer::range_constrain_two_limbs(const uint32_t lo_idx,
//                                                    const uint32_t hi_idx,
//                                                    const size_t lo_limb_bits,
//                                                    const size_t hi_limb_bits)
// {
//     // Validate limbs are <= 70 bits. If limbs are larger we require more witnesses and cannot use our limb
//     accumulation
//     // custom gate
...
//  */
// std::array<uint32_t, 2> UltraPlonkComposer::decompose_non_native_field_double_width_limb(const uint32_t limb_idx,
...
//  * Where a, b, q, r are all emulated non-native field elements that are each split across 4 distinct witness
//  variables
//  *
...
//  **/
// std::array<uint32_t, 2> UltraPlonkComposer::evaluate_non_native_field_multiplication(
...
//  *
//  **/
// std::array<uint32_t, 2> UltraPlonkComposer::evaluate_partial_non_native_field_multiplication(
...
//  **/
// std::array<uint32_t, 5> UltraPlonkComposer::evaluate_non_native_field_addition(
//     add_simple limb0,
//     add_simple limb1,
//     add_simple limb2,
//     add_simple limb3,
...
// std::array<uint32_t, 5> UltraPlonkComposer::evaluate_non_native_field_subtraction(
//     add_simple limb0,
//     add_simple limb1,
//     add_simple limb2,
//     add_simple limb3,
...
//  */
// void UltraPlonkComposer::create_ROM_gate(RomRecord& record)
// {
...
//  * @param record Stores details of this read operation. Mutated by this fn!
//  */
// void UltraPlonkComposer::create_sorted_ROM_gate(RomRecord& record)
// {
//     record.record_witness = add_variable(0);
...
//  */
// size_t UltraPlonkComposer::create_ROM_array(const size_t array_size)
// {
...
//  * @param record Stores details of this read operation. Mutated by this fn!
//  */
// void UltraPlonkComposer::create_RAM_gate(RamRecord& record)
// {
...
//  * @param record Stores details of this read operation. Mutated by this fn!
//  */
// void UltraPlonkComposer::create_sorted_RAM_gate(RamRecord& record)
// {
//     record.record_witness = add_variable(0);
...
//  * @param record Stores details of this read operation. Mutated by this fn!
//  */
// void UltraPlonkComposer::create_final_sorted_RAM_gate(RamRecord& record, const size_t ram_array_size)
// {
//     record.record_witness = add_variable(0);
//     record.gate_index = num_gates;
...
//  * @return size_t The index of the element
//  */
// size_t UltraPlonkComposer::create_RAM_array(const size_t array_size)
// {
...
//  */
// void UltraPlonkComposer::init_RAM_element(const size_t ram_id, const size_t index_value, const uint32_t
// value_witness)
// {
...
// uint32_t UltraPlonkComposer::read_RAM_array(const size_t ram_id, const uint32_t index_witness)
// {
//     ASSERT(ram_arrays.size() > ram_id);
//     RamTranscript& ram_array = ram_arrays[ram_id];
...
// void UltraPlonkComposer::write_RAM_array(const size_t ram_id,
...
//  * @param value_witness The index of the witness with the value that should be in the
//  */
// void UltraPlonkComposer::set_ROM_element(const size_t rom_id, const size_t index_value, const uint32_t value_witness)
// {
...
// void UltraPlonkComposer::set_ROM_element_pair(const size_t rom_id,
...
// uint32_t UltraPlonkComposer::read_ROM_array(const size_t rom_id, const uint32_t index_witness)
// {
//     ASSERT(rom_arrays.size() > rom_id);
//     RomTranscript& rom_array = rom_arrays[rom_id];
//     const uint32_t index = static_cast<uint32_t>(uint256_t(get_variable(index_witness)));
...
// std::array<uint32_t, 2> UltraPlonkComposer::read_ROM_array_pair(const size_t rom_id, const uint32_t index_witness)
// {
...
//  */
// void UltraPlonkComposer::process_ROM_array(const size_t rom_id, const size_t gate_offset_from_public_inputs)
// {
...
//  * @param gate_offset_from_public_inputs Required to track the gate position of where we're adding extra gates
//  */
// void UltraPlonkComposer::process_RAM_array(const size_t ram_id, const size_t gate_offset_from_public_inputs)
// {
//     RamTranscript& ram_array = ram_arrays[ram_id];
...
// void UltraPlonkComposer::process_ROM_arrays(const size_t gate_offset_from_public_inputs)
// {
//     for (size_t i = 0; i < rom_arrays.size(); ++i) {
//         process_ROM_array(i, gate_offset_from_public_inputs);
//     }
// }
// void UltraPlonkComposer::process_RAM_arrays(const size_t gate_offset_from_public_inputs)
// {
