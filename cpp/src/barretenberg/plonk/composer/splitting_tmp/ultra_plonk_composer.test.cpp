...
// TEST(ultra_plonk_composer_splitting_tmp, create_gates_from_plookup_accumulators_debug)
// {
...
//         num_lookups_lo]); EXPECT_EQ(composer.get_variable(lookup_witnesses_hi[ColumnIdx::C2][i]), expected_x[i +
//         num_lookups_lo]); EXPECT_EQ(composer.get_variable(lookup_witnesses_hi[ColumnIdx::C3][i]), expected_y[i +
//         num_lookups_lo]);
//     }
