...
//                 witness_ct(&composer, fr(uint256_t(P1.x).slice(fq_ct::NUM_LIMB_BITS * 2, fq_ct::NUM_LIMB_BITS *
//                 4))));
//             fq_ct y1(
//                 witness_ct(&composer, fr(uint256_t(P1.y).slice(0, fq_ct::NUM_LIMB_BITS * 2))),
//                 witness_ct(&composer, fr(uint256_t(P1.y).slice(fq_ct::NUM_LIMB_BITS * 2, fq_ct::NUM_LIMB_BITS *
//                 4))));
//             fq_ct x2(
//                 witness_ct(&composer, fr(uint256_t(P2.x).slice(0, fq_ct::NUM_LIMB_BITS * 2))),
//                 witness_ct(&composer, fr(uint256_t(P2.x).slice(fq_ct::NUM_LIMB_BITS * 2, fq_ct::NUM_LIMB_BITS *
//                 4))));
//             fq_ct y2(
//                 witness_ct(&composer, fr(uint256_t(P2.y).slice(0, fq_ct::NUM_LIMB_BITS * 2))),
//                 witness_ct(&composer, fr(uint256_t(P2.y).slice(fq_ct::NUM_LIMB_BITS * 2, fq_ct::NUM_LIMB_BITS *
//                 4))));
//             uint64_t before = composer.get_num_gates();
...
//                 witness_ct(&composer, fr(uint256_t(input).slice(fq_ct::NUM_LIMB_BITS * 2, fq_ct::NUM_LIMB_BITS *
//                 4))), false);
//         auto a1 = a;
//         auto a2 = a;
//         auto a3 = a;
