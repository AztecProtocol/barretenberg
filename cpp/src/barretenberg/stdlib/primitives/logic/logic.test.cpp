...
//     Types<proof_system::StandardCircuitBuilder, proof_system::TurboCircuitBuilder,
...
// // Tests the constraints will fail if the operands are larger than expected even though the result contains the
// correct
// // number of bits when using the UltraPlonkComposer This is because the range constraints on the right and left
// operand
...
// // happen if the composer doesn't support lookup gates because constraints will be created for each bit of the left
// and
// // right operand.
