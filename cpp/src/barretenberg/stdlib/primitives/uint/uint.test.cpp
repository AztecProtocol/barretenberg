...
//             a_expected = c_expected;
//             c_expected = (a_expected + b_expected) ^
//                          (static_cast<uint_native>(0x10000000a3b10422) ^
...
//                 bool expected = static_cast<uint_native>(b_val + const_b) > static_cast<uint_native>(a_val +
//                 const_a); uint_ct a = witness_ct(&composer, a_val); uint_ct b = witness_ct(&composer, b_val); uint_ct
//                 a_shift = uint_ct(&composer, const_a); uint_ct b_shift = uint_ct(&composer, const_b); uint_ct c = a +
//                 a_shift; uint_ct d = b + b_shift; bool_ct e = d > c; bool result = bool(e.get_value());
...
//             uint_native const_a = get_random<uint_native>();
//             uint_native a_val = get_random<uint_native>();
//             uint_native expected = static_cast<uint_native>(ror(static_cast<uint_native>(const_a + a_val),
//             rotation)); uint_ct a = is_constant ? uint_ct(&composer, a_val) : witness_ct(&composer, a_val); uint_ct
//             a_shift = uint_ct(&composer, const_a); uint_ct c = a + a_shift; uint_ct d = c.ror(rotation); uint_native
//             result = uint_native(d.get_value());
...
//             uint_native const_a = get_random<uint_native>();
//             uint_native a_val = get_random<uint_native>();
//             uint_native expected = static_cast<uint_native>(rol(static_cast<uint_native>(const_a + a_val),
//             rotation)); uint_ct a = is_constant ? uint_ct(&composer, a_val) : witness_ct(&composer, a_val); uint_ct
//             a_shift = uint_ct(&composer, const_a); uint_ct c = a + a_shift; uint_ct d = c.rol(rotation); uint_native
//             result = uint_native(d.get_value());
