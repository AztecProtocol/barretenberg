...
//  */
// template <typename Composer, size_t SIZE> field_t<Composer> array_length(std::array<field_t<Composer>, SIZE> const&
// arr)
// {
...
//  * something else.
//  */
// template <typename Composer, typename T, size_t SIZE> inline void array_push(std::array<T, SIZE>& arr, T const&
// value)
// {
//     bool_t<Composer> already_pushed = false;
//     for (size_t i = 0; i < arr.size(); ++i) {
