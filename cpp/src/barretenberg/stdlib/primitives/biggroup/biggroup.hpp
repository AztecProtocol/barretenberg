...
template <class Composer, class Fq, class Fr, class NativeGroup> class element {
  ...
  private:
    template <size_t num_elements,
              typename = typename std::enable_if<std::is_same<Composer, plonk::UltraPlonkComposer>::value>>
    ...
    template <typename = typename std::enable_if<std::is_same<Composer, plonk::UltraPlonkComposer>::value>>
     ...
     **/
    template <typename X = typename std::enable_if<std::is_same<Composer, plonk::UltraPlonkComposer>::value>>
