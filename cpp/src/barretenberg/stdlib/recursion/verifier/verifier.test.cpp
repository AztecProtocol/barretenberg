...
//     typedef proof_system::plonk::stdlib::recursion::recursive_ultra_verifier_settings<outer_curve>
//     recursive_settings; typedef
//     proof_system::plonk::stdlib::recursion::recursive_ultra_to_standard_verifier_settings<outer_curve>
...
//         // An Ultra Pedersen hash evaluates to a different value from the Turbo/Standard versions of the Pedersen
//         hash.
//         // Therefore, the fiat-shamir challenges generated by the prover and verifier _could_ accidentally be
//         different
//         // if an ultra proof is generated using ultra-pedersen challenges, but is being verified within a non-ultra
//         // circuit which uses non-ultra-pedersen challenges. We need the prover and verifier hashes to be the same.
//         The
...
//         typedef typename std::conditional<is_ultra_to_ultra, plonk::UltraVerifier,
//         plonk::UltraToStandardVerifier>::type
//             VerifierOfInnerProof;
//         typedef
//             typename std::conditional<is_ultra_to_ultra, recursive_settings,
//             ultra_to_standard_recursive_settings>::type
//                 RecursiveSettings;
...
//         info("Verifying the ultra (inner) proof with CIRCUIT TYPES (i.e. within a standard plonk arithmetic
//         circuit):"); stdlib::recursion::aggregation_state<outer_curve> output =
...
//         } else {
//             verification_key = proof_type ? verification_key_pt::from_witness(&outer_composer,
//             verification_key_raw_a)
//                                           : verification_key_pt::from_witness(&outer_composer,
//                                           verification_key_raw_b);
//         }
...
//         auto circuit_output =
//             create_outer_circuit_with_variable_inner_circuit(inner_composer_a, inner_composer_b, outer_composer,
//             true);
