...
//     typedef proof_system::plonk::stdlib::recursion::recursive_turbo_verifier_settings<outer_curve>
//     recursive_settings; typedef inner_curve::fr_ct fr_ct; typedef inner_curve::public_witness_ct public_witness_ct;
