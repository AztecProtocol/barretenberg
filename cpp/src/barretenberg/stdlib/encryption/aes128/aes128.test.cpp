...
TEST(stdlib_aes128, encrypt_64_bytes)
{
    ...
    typedef proof_system::plonk::stdlib::witness_t<plonk::UltraComposer> witness_pt;
    ...
    const auto result = proof_system::plonk::stdlib::aes128::encrypt_buffer_cbc(in_field, iv_field, key_field);
