...
TEST(stdlib_sha256, test_duplicate_proving_key)
{
    ...
    plonk::StandardComposer first_composer = proof_system::plonk::StandardComposer();
    ...
    plonk::StandardComposer second_composer =
        proof_system::plonk::StandardComposer(proving_key, verification_key, circuit_size);
...
//         w_elements[i] = proof_system::plonk::stdlib::witness_t<plonk::UltraComposer>(&composer,
...
{
    typedef proof_system::plonk::stdlib::field_t<plonk::UltraComposer> field_pt;
    typedef proof_system::plonk::stdlib::packed_byte_array<plonk::UltraComposer> packed_byte_array_pt;
...
HEAVY_TEST(stdlib_sha256, test_NIST_vector_five)
{
    ...
    packed_byte_array_pt output_bits = proof_system::plonk::stdlib::sha256<plonk::UltraComposer>(input);
