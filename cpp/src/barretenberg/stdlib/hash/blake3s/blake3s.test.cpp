...
typedef proof_system::plonk::TurboPlonkComposer Composer;
typedef stdlib::byte_array<Composer> byte_array;
typedef stdlib::byte_array<plonk::UltraPlonkComposer> byte_array_plookup;
typedef stdlib::public_witness_t<Composer> public_witness_t;
typedef stdlib::public_witness_t<plonk::UltraPlonkComposer> public_witness_t_plookup;
...
TEST(stdlib_blake3s, test_single_block_plookup)
{
    ...
    byte_array_plookup output = stdlib::blake3s<plonk::UltraPlonkComposer>(input_arr);
