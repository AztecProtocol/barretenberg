...
void create_logic_gate(
    UltraComposer& composer, uint32_t a, uint32_t b, uint32_t result, size_t num_bits, bool is_xor_gate);

void xor_gate(UltraComposer& composer, uint32_t a, uint32_t b, uint32_t result, size_t num_bits);

void and_gate(UltraComposer& composer, uint32_t a, uint32_t b, uint32_t result, size_t num_bits);
