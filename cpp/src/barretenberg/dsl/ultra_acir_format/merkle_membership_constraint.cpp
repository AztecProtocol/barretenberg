...
void create_merkle_check_membership_constraint(plonk::UltraComposer& composer, const MerkleMembershipConstraint& input)
{
    ...
    hash_path<plonk::UltraComposer> hash_path;
