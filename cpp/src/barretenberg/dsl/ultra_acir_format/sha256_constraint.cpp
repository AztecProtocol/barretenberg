...
void create_sha256_constraints(plonk::UltraComposer& composer, const Sha256Constraint& constraint)
{
    ...
    // Compute sha256
    packed_byte_array_ct output_bytes = plonk::stdlib::sha256<plonk::UltraComposer>(arr);
