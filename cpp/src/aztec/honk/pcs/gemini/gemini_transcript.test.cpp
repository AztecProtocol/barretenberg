...
TYPED_TEST(GeminiTranscriptTest, single_with_transcript)
{
    ...
    auto verifier_claim = Gemini::reduce_verify_with_transcript(u, claims, {}, proof, transcript);
...
TYPED_TEST(GeminiTranscriptTest, shift_with_transcript)
{
    ...
    auto verifier_claim = Gemini::reduce_verify_with_transcript(u, {}, claims_shift, proof, transcript);
...
TYPED_TEST(GeminiTranscriptTest, double_shift_with_transcript)
{
    ...
    auto verifier_claim = Gemini::reduce_verify_with_transcript(u, claims, claims_shift, proof, transcript);
