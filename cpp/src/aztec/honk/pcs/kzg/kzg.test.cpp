...
TYPED_TEST(BilinearAccumulationTest, GeminiShplonkKzgSimpleExplicit)
{
    using Transcript = transcript::StandardTranscript;
    using Shplonk = shplonk::SingleBatchOpeningScheme<TypeParam>;
    using Gemini = gemini::MultilinearReductionScheme<TypeParam>;
    using MLEOpeningClaim = MLEOpeningClaim<TypeParam>;
    using OpeningScheme = UnivariateOpeningScheme<TypeParam>;
    using Polynomial = barretenberg::Polynomial<typename TypeParam::Fr>;
    ...
    // Generate multilinear polynomials, their commitments (genuine and mocked) and evaluations (genuine) at a random
    // point.
    auto u_1 = Fr{ { 0x4ac1ea7af29cc770, 0x40733db712e7cdae, 0xe139ec4fc13ef3c2, 0x2a1fd70c7177241c } };
    auto u_2 = Fr{ { 0x79cefb0a25ad817e, 0x683568399e60b353, 0x6f1fa28356211c4e, 0x09d12a29bda26724 } };
    auto u_3 = Fr{ { 0x0b603f55c34e9668, 0x6016558cde97b60f, 0x0f069898802040dd, 0x26de66fe5518355c } };
    info("test: u_1 = ", u_1);
    info("test: u_2 = ", u_2);
    info("test: u_3 = ", u_3);
    std::vector<Fr> mle_opening_point = { u_1, u_2, u_3 }; // sometimes denoted 'u'
    // const auto mle_opening_point = this->random_evaluation_point(log_n); // sometimes denoted 'u'
    Polynomial poly1(n, n);
    poly1[0] = 0;
    poly1[1] = 1;
    poly1[2] = 2;
    ...
    auto eval_of_w_1 = Fr{ { 0x4f66ec99f4318993, 0x0e7cbf5dd4ac880c, 0x2fb00417bf105c9c, 0x1b57d25c561de03c } };
    info("test: eval_of_w_1 = ", eval_of_w_1);

    EXPECT_EQ(eval1, eval_of_w_1);
