...
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
    fr a = fr::one();
...
TEST(turbo_circuit_constructor, test_check_circuit_add_gate_proofs_correct)
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
    fr a = fr::one();
    fr b = fr::one();
...
TEST(turbo_circuit_constructor, test_check_circuit_add_gate_proofs_broken)
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
    fr a = fr::one();
    fr b = fr::one();
...
TEST(turbo_circuit_constructor, test_check_circuit_mul_gate_proofs_correct)
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
    fr q[7]{ fr::random_element(), fr::random_element(), fr::random_element(), fr::random_element(),
             fr::random_element(), fr::random_element(), fr::random_element() };
...
TEST(turbo_circuit_constructor, test_check_circuit_mul_gate_proofs_broken)
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
    fr q[7]{ fr::random_element(), fr::random_element(), fr::random_element(), fr::random_element(),
             fr::random_element(), fr::random_element(), fr::random_element() };
...
TEST(turbo_circuit_constructor, test_check_circuit_fixed_group)
{
    constexpr size_t num_bits = 254;
    constexpr size_t num_quads_base = (num_bits - 1) >> 1;
    constexpr size_t num_quads = ((num_quads_base << 1) + 1 < num_bits) ? num_quads_base + 1 : num_quads_base;
...
TEST(turbo_circuit_constructor, test_check_circuit_range_constraint)
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
...
TEST(turbo_circuit_constructor, test_check_circuit_xor)
{
    honk::TurboCircuitConstructor composer = honk::TurboCircuitConstructor();
