...
TYPED_TEST(MultivariatesTests, FoldTwoRoundsSpecial)
{
    ...
    auto multivariates = Multivariates<FF, num_polys>(multivariate_n);
    ...
    multivariates.fold(full_polynomials, multivariate_n, round_challenge_2);
...
TYPED_TEST(MultivariatesTests, FoldThreeRoundsSpecial)
{
    ...
    multivariates.fold(full_polynomials, multivariate_n, round_challenge_3);
