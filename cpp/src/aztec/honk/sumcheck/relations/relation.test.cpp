...
template <class FF> class SumcheckRelation : public testing::Test {
  public:
    ...
    static std::array<Univariate<5>, onk::StandardArithmetization::NUM_POLYNOMIALS> compute_mock_extended_edges()
    {
        ...
        std::array<Univariate<5>, onk::StandardArithmetization::NUM_POLYNOMIALS> extended_edges = {
...
TYPED_TEST(SumcheckRelation, ArithmeticRelation)
{
    ...
    using MULTIVARIATE = onk::StandardArithmetization::POLYNOMIAL;
