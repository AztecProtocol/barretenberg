        ...
        manifest_rounds.emplace_back(transcript::Manifest::RoundManifest(       
            {
              ...
              { .name = "z_perm_shift", .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 4 },
              { .name = "q_m",          .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 5 },
              ...
              { .name = "q_c",          .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 9 },
              { .name = "sigma_1",      .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 10 },
              { .name = "sigma_2",      .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 11 },
              { .name = "sigma_3",      .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 12 },
              { .name = "id_1",         .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 13 },
              { .name = "id_2",         .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 14 },
              { .name = "id_3",         .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 15 },
              { .name = "L_first",      .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 16 },
              { .name = "L_last",       .num_bytes = fr_size, .derived_by_verifier = false, .challenge_map_index = 17 },
            },
            /* challenge_name = */ "rho",
