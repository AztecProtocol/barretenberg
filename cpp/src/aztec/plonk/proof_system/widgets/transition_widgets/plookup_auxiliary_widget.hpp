...
template <class Field, class Getters, typename PolyContainer> class PlookupAuxiliaryKernel {
  ...
  public:
                                                ...
                                                const size_t i = 0)
    {
         ...
         *  * r: `record` of memory cell. record = index * eta + timestamp * eta^2 + value * eta^3
         *
         ...
         *
         * For two adjacent entries in the sorted list, their values must match iff:
         *  * index values match
         *  * adjacent access value is 0 (i.e. next gate is a READ)
         *
