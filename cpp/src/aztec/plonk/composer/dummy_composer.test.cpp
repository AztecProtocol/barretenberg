...
TEST(dummy_composer, composer_from_serialized_keys)
{
    DummyComposer composer = DummyComposer();
    fr a = fr::one();
    composer.add_public_variable(a);
    ...
    DummyComposer composer2 = DummyComposer(proving_key, verification_key);
...
TEST(dummy_composer, test_add_gate_proofs)
{
    DummyComposer composer = DummyComposer();
    fr a = fr::one();
...
TEST(dummy_composer, test_mul_gate_proofs)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, range_constraint)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, range_constraint_fail)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, and_constraint)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, xor_constraint)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, big_add_gate_with_bit_extract)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, test_composer)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, test_range_constraint_fail)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, test_check_circuit_correct)
{
    DummyComposer composer = DummyComposer();
    fr a = fr::one();
    uint32_t a_idx = composer.add_public_variable(a);
...
TEST(dummy_composer, test_check_circuit_broken)
{
    DummyComposer composer = DummyComposer();
    fr a = fr::one();
    uint32_t a_idx = composer.add_public_variable(a);
...
TEST(dummy_composer, test_fixed_group_add_gate_with_init)
{
    DummyComposer composer = DummyComposer();
...
TEST(dummy_composer, test_fixed_group_add_gate)
{
    auto composer = DummyComposer();
    auto gen_data = crypto::generators::get_generator_data({ 0, 0 });
