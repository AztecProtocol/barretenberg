...
template <typename Prover> class ultra_composer_tests : public testing::Test {

  public:
    numeric::random::Engine& engine = numeric::random::get_debug_engine();

    static std::vector<uint32_t> add_variables(waffle::UltraComposer& composer, std::vector<fr> variables)
    {
    ...
    static bool create_and_verify_proof(waffle::UltraComposer& composer)
    {
        bool result = false;
        if constexpr (std::is_same_v<Prover, waffle::UltraProver>) {
        ...
        } else if constexpr (std::is_same_v<Prover, waffle::UnrolledUltraProver>) {
    ...
    static void create_gates_from_plookup_accumulators()
    {
        ...
        for (size_t i = 0; i < num_lookups_hi; ++i) {
            EXPECT_EQ(composer.get_variable(lookup_witnesses_hi[ColumnIdx::C1][i]),
        ...
        auto result = create_and_verify_proof(composer);
        EXPECT_EQ(result, true);
    }

    static void no_lookup_proof()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
    ...
    static void non_trivial_tag_permutation()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
    ...
    static void non_trivial_tag_permutation_and_cycles()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
        fr a = fr::random_element();
        fr c = -a;
    ...
    static void bad_tag_permutation_fails()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
        fr a = fr::random_element();
        fr b = -a;
    ...
    static void sort_with_edge_gates()
    {
        fr a = fr::one();
        fr b = fr(2);
        fr c = fr(3);
...

        {
            ...
            composer.create_sort_constraint_with_edges(
    ...
    static void range_with_other_gates()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
    ...
    static void sort_widget_complex()
    {
        {
            waffle::UltraComposer composer = waffle::UltraComposer();
    ...
    static void sort_widget_neg_fails()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
        fr a = fr::one();
        fr b = fr(2);
    ...
    static void composed_range_constraint()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
    ...
    static void non_native_field_multiplication()
    {
        waffle::UltraComposer composer = waffle::UltraComposer();
...
typedef testing::Types<waffle::UltraProver, waffle::UnrolledUltraProver> ProverTypes;

TYPED_TEST_SUITE(ultra_composer_tests, ProverTypes);

TYPED_TEST(ultra_composer_tests, create_gates_from_plookup_accumulators)
{
    TestFixture::create_gates_from_plookup_accumulators();
};

TYPED_TEST(ultra_composer_tests, no_lookup_proof)
{
    TestFixture::no_lookup_proof();
};

TYPED_TEST(ultra_composer_tests, elliptic_gate)
{
    TestFixture::elliptic_gate();
};

TYPED_TEST(ultra_composer_tests, non_trivial_tag_permutation)
{
    TestFixture::non_trivial_tag_permutation();
};

TYPED_TEST(ultra_composer_tests, non_trivial_tag_permutation_and_cycles)
{
    TestFixture::non_trivial_tag_permutation_and_cycles();
};

TYPED_TEST(ultra_composer_tests, bad_tag_permutation_fails)
{
    TestFixture::bad_tag_permutation_fails();
};

TYPED_TEST(ultra_composer_tests, sort_with_edge_gates)
{
    TestFixture::sort_with_edge_gates();
};

TYPED_TEST(ultra_composer_tests, range_constraint)
{
    TestFixture::range_constraint();
};

TYPED_TEST(ultra_composer_tests, range_with_other_gates)
{
    TestFixture::range_with_other_gates();
};

TYPED_TEST(ultra_composer_tests, sort_widget_complex)
{
    TestFixture::sort_widget_complex();
};

TYPED_TEST(ultra_composer_tests, sort_widget_neg_fails)
{
    TestFixture::sort_widget_neg_fails();
};

TYPED_TEST(ultra_composer_tests, composed_range_constraint)
{
    TestFixture::composed_range_constraint();
};

TYPED_TEST(ultra_composer_tests, non_native_field_multiplication)
{
    TestFixture::non_native_field_multiplication();
};

TYPED_TEST(ultra_composer_tests, rom)
{
    TestFixture::rom();
};