...
template class uint<honk::StandardPlonkComposer, uint8_t>;
template class uint<honk::StandardPlonkComposer, uint16_t>;
template class uint<honk::StandardPlonkComposer, uint32_t>;
template class uint<honk::StandardPlonkComposer, uint64_t>;
