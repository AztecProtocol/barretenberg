...
void create_hash_to_field_constraints(waffle::UltraComposer& composer, const HashToFieldConstraint constraint)
{
    ...
    byte_array_ct out_bytes = plonk::stdlib::blake2s<waffle::UltraComposer>(arr);
