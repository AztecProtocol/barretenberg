...
void create_sha256_constraints(waffle::UltraComposer& composer, const Sha256Constraint& constraint)
{
    ...
    // Compute sha256
    byte_array_ct output_bytes = plonk::stdlib::sha256<waffle::UltraComposer>(arr);
