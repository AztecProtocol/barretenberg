...
void create_blake2s_constraints(waffle::UltraComposer& composer, const Blake2sConstraint& constraint)
{
    ...
    byte_array_ct output_bytes = plonk::stdlib::blake2s<waffle::UltraComposer>(arr);
