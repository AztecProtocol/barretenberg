...
crypto::ecdsa::signature ecdsa_convert_signature(waffle::UltraComposer& composer, std::vector<uint32_t> signature)
{
...
namespace stdlib {
namespace secp256k {
typedef typename secp256k1_ct::fq_ct fq;
typedef typename secp256k1_ct::fr_ct fr;
typedef typename secp256k1_ct::g1_ct g1;

} // namespace secp256k
} // namespace stdlib
} // namespace plonk

secp256k1_ct::g1_ct ecdsa_convert_inputs(waffle::UltraComposer* ctx, const secp256k1::g1::affine_element& input)
{
...
byte_array_ct ecdsa_vector_of_bytes_to_byte_array(waffle::UltraComposer& composer,
...
witness_ct ecdsa_index_to_witness(waffle::UltraComposer& composer, uint32_t index)
{
...
void create_ecdsa_verify_constraints(waffle::UltraComposer& composer, const EcdsaSecp256k1Constraint& input)
{
    ...
    stdlib::ecdsa::signature<waffle::UltraComposer> sig{ stdlib::byte_array<waffle::UltraComposer>(&composer, rr),
                                                         stdlib::byte_array<waffle::UltraComposer>(&composer, ss) };

    auto pub_key = secp256k1_ct::g1_ct(pub_key_x_fq, pub_key_y_fq);

    // stdlib::bool_t<waffle::UltraComposer> signature_result = stdlib::ecdsa::
    //     verify_signature<waffle::UltraComposer, secp256k1_ct::fq_ct, secp256k1_ct::fr_ct, secp256k1_ct::g1>(
    //         message, pub_key, sig);
