...
struct MerkleInsertConstraint {
    ...
    uint32_t old_root;               // Single field element -- field_ct
    uint32_t new_root;               // Single field element -- field_ct -- the new root
    uint32_t old_leaf;               // Single field element -- field_ct
    uint32_t new_leaf;               // Single field element -- field_ct
    uint32_t index;
};

void create_merkle_insert_constraint(waffle::UltraComposer& composer, const MerkleInsertConstraint& input)
{
    ...
    hash_path<waffle::UltraComposer> hash_path;
    ...
    // void update_membership(field_ct<Composer> const& new_root,
    //                        field_ct<Composer> const& new_value,
    //                        field_ct<Composer> const& old_root,
    //                        hash_path<Composer> const& old_hashes,
    //                        field_ct<Composer> const& old_value,
