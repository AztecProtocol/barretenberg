...
void create_circuit(UltraComposer& composer, const standard_format& constraint_system)
{
...
UltraComposer create_circuit(const standard_format& constraint_system,
...
UltraComposer create_circuit_with_witness(const standard_format& constraint_system,
...
UltraComposer create_circuit_with_witness(const standard_format& constraint_system, std::vector<fr> witness)
{
    if (constraint_system.public_inputs.size() > constraint_system.varnum) {
        std::cout << "too many public inputs!" << std::endl;
    }
