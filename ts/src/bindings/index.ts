...
export function schnorrConstructSignature(message: Buffer, privateKey: Fr): [
    Buffer32,
    Buffer32
] {
...
export function schnorrMultisigValidateAndCombineSignerPubkeys(signerPubkeyBuf: Buffer128[]): [
    Point,
    boolean
] {
...
export function schnorrMultisigConstructSignatureRound1(): [
    Buffer128,
    Buffer128
] {
    const inArgs: Array<any> = [];
...
export function schnorrMultisigConstructSignatureRound2(message: Buffer, privateKey: Fq, signerRoundOnePrivateBuf: Buffer128, signerPubkeysBuf: Buffer128[], roundOnePublicBuf: Buffer128[]): [
    Fq,
    boolean
] {
...
export function schnorrMultisigCombineSignatures(message: Buffer, signerPubkeysBuf: Buffer128[], roundOneBuf: Buffer128[], roundTwoBuf: Fr[]): [
    Buffer32,
    Buffer32,
    boolean
] {
