...
type FilterOutAttributes<Base> = {
  [Key in keyof Base]: Base[Key] extends (...arg0: any[]) => any ? Base[Key] : never;
};

type PromisifyFunction<F extends (...arg0: any[]) => any> = (...args: Parameters<F>) => Promise<ReturnType<F>>;

type Promisify<Base extends { [key: string]: (...arg0: any[]) => any }> = {
...
type Transferrable<Base extends { [key: string]: (...arg0: any[]) => any }> = {
